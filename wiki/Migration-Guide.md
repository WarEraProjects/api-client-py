...
5. **Built-in Telemetry Hooks**: You can pass a `TelemetryHooks` object to observe internal rate-limit sleep durations, chunk payload efficiencies, and cache hit ratios for Datadog/Prometheus tracking.
